...
test('회귀 ★ ?v= 갱신(patent.js 20260705-editdedup · patent.css 20260659)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260705-editdedup/, '★ patent.js ?v=20260705-editdedup(split-loader)');
