...
test('회귀 ★ ?v= 갱신(patent.js 20260814i · patent.css 20260814i)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260814i/, '★ patent.js ?v=20260814i(split-loader)');
  assert.match(HTML_SRC, /patent\/patent\.css\?v=20260814i/, '★ patent.css ?v=20260814i(이번 PR 미변경)');
});
