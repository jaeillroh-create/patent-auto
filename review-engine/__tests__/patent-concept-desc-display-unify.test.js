...
test('회귀 ★ ?v= 갱신(patent.js 20260710-chk6scope · patent.css 20260659)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260710-chk6scope/, '★ patent.js ?v=20260710-chk6scope(split-loader)');
