...
test('회귀 ★ ?v= 갱신(patent.js 20260814j · patent.css 20260814j)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260814j/, '★ patent.js ?v=20260814j(split-loader)');
  assert.match(HTML_SRC, /patent\/patent\.css\?v=20260814j/, '★ patent.css ?v=20260814j(이번 PR 미변경)');
});
