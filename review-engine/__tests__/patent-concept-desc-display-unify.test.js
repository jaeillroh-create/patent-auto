...
test('회귀 ★ ?v= 갱신(patent.js 20260814c · patent.css 20260814c)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260814c/, '★ patent.js ?v=20260814c(split-loader)');
  assert.match(HTML_SRC, /patent\/patent\.css\?v=20260814c/, '★ patent.css ?v=20260814c(이번 PR 미변경)');
});
