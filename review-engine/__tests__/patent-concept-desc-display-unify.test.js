...
test('회귀 ★ ?v= 갱신(patent.js 20260720-unified · patent.css 20260659)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260720-unified/, '★ patent.js ?v=20260720-unified(split-loader)');
