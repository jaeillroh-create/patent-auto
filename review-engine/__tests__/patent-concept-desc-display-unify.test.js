...
test('회귀 ★ ?v= 갱신(patent.js 20260709-fallback6 · patent.css 20260659)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260709-fallback6/, '★ patent.js ?v=20260709-fallback6(split-loader)');
