...
test('회귀 ★ ?v= 갱신(patent.js 20260706-claimgate · patent.css 20260659)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260706-claimgate/, '★ patent.js ?v=20260706-claimgate(split-loader)');
