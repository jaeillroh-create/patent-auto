...
test('회귀 ★ ?v= 갱신(patent.js 20260702-straighten · patent.css 20260659)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260702-straighten/, '★ patent.js ?v=20260702-straighten(split-loader)');
