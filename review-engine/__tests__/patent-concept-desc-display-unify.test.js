...
test('회귀 ★ ?v= 갱신(patent.js 20260704-headingdup · patent.css 20260659)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260704-headingdup/, '★ patent.js ?v=20260704-headingdup(split-loader)');
