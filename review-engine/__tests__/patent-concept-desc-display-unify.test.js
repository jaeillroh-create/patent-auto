...
test('회귀 ★ ?v= 갱신(patent.js 20260723-scope-retry · patent.css 20260659)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260723-scope-retry/, '★ patent.js ?v=20260723-scope-retry(split-loader)');
