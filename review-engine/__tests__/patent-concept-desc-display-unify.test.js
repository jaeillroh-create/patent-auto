...
test('회귀 ★ ?v= 갱신(patent.js 20260707-jepson · patent.css 20260659)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260707-jepson/, '★ patent.js ?v=20260707-jepson(split-loader)');
