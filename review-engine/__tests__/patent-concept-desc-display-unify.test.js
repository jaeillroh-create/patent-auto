...
test('회귀 ★ ?v= 갱신(patent.js 20260814d · patent.css 20260814d)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260814d/, '★ patent.js ?v=20260814d(split-loader)');
  assert.match(HTML_SRC, /patent\/patent\.css\?v=20260814d/, '★ patent.css ?v=20260814d(이번 PR 미변경)');
});
