...
test('회귀 ★ ?v= 갱신(patent.js 20260708-length · patent.css 20260659)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260708-length/, '★ patent.js ?v=20260708-length(split-loader)');
