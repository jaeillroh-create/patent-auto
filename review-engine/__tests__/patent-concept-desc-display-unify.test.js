...
test('회귀 ★ ?v= 갱신(patent.js 20260814f · patent.css 20260814f)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260814f/, '★ patent.js ?v=20260814f(split-loader)');
  assert.match(HTML_SRC, /patent\/patent\.css\?v=20260814f/, '★ patent.css ?v=20260814f(이번 PR 미변경)');
});
