...
test('회귀 ★ ?v= 갱신(patent.js 20260721-fullchain · patent.css 20260659)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260721-fullchain/, '★ patent.js ?v=20260721-fullchain(split-loader)');
