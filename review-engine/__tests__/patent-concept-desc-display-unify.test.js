...
test('회귀 ★ ?v= 갱신(patent.js 20260814b · patent.css 20260814b)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260814b/, '★ patent.js ?v=20260814b(split-loader)');
  assert.match(HTML_SRC, /patent\/patent\.css\?v=20260814b/, '★ patent.css ?v=20260814b(이번 PR 미변경)');
});
