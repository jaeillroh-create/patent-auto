...
test('회귀 ★ ?v= 갱신(patent.js 20260713-cleanup · patent.css 20260659)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260713-cleanup/, '★ patent.js ?v=20260713-cleanup(split-loader)');
