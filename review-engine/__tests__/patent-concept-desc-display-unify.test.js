...
test('회귀 ★ ?v= 갱신(patent.js 20260814e · patent.css 20260814e)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260814e/, '★ patent.js ?v=20260814e(split-loader)');
  assert.match(HTML_SRC, /patent\/patent\.css\?v=20260814e/, '★ patent.css ?v=20260814e(이번 PR 미변경)');
});
