...
test('회귀 ★ ?v= 갱신(patent.js 20260703-specvalidate · patent.css 20260659)', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260703-specvalidate/, '★ patent.js ?v=20260703-specvalidate(split-loader)');
