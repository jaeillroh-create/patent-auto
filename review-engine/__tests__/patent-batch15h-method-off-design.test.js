...
test('15H 회귀 ★ — ?v= 릴리스 토큰 b50 갱신', () => {
  assert.match(HTML_SRC, /patent\/patent\.js\?v=20260814g/, '★ index.html patent.js 토큰 b50');
  assert.match(readFileSync(path.join(REPO, 'patent/patent.js'), 'utf8'), /version = '20260814g'/, '★ patent.js 로더 version b50');
});
